//
//  DeleteProductFromBackendIntImpl.swift
//  fisioapp
//
...
class DeleteProductFromBackendIntImpl: DeleteProductFromBackendInteractor {
    func execute(token: String, id: String, onSuccess: @escaping (String) -> Void, onError: @escaping (String) -> Void) {
        
        let urlAPI = URL(string: DEBUG_HTTP_SERVER + FISIOAPP_PRODUCTS_SERVER_PATH + "/" + id)
